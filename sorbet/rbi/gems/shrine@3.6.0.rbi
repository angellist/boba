...
# pkg:gem/shrine#lib/shrine.rb:36
module Shrine::ClassMethods
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:88
  ...
  # A logger instance.
  #
  # pkg:gem/shrine#lib/shrine.rb:44
  def logger; end
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:38
  def opts; end
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:107
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:116
  def uploaded_file(object); end

  # Prints a warning to the logger.
  #
  # pkg:gem/shrine#lib/shrine.rb:152
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:136
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:164
...
module Shrine::InstanceMethods
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:228
  ...
  # location.
  #
  # pkg:gem/shrine#lib/shrine.rb:222
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:204
  ...
  # error is raised.
  #
  # pkg:gem/shrine#lib/shrine.rb:308
  def _enforce_io(io); end

  # pkg:gem/shrine#lib/shrine.rb:244
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:299
  ...
  #
  # pkg:gem/shrine#lib/shrine.rb:284
...
module Shrine::Plugins
  class << self
    ...
    #
    # pkg:gem/shrine#lib/shrine/plugins.rb:33
    ...
    #
    # pkg:gem/shrine#lib/shrine/plugins.rb:47
...
module Shrine::UploadedFile::InstanceMethods
  ...
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:121
  def download(**options); end

  # Part of complying to the IO interface. It delegates to the internally
  # opened IO object.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:159
  def eof?; end

  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:231
  def eql?(other); end

  # Calls `#exists?` on the storage, which checks whether the file exists
  # on the storage.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:188
  def exists?; end

  # The extension derived from #id if present, otherwise it's derived
  # from #original_filename.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:52
  def extension; end

  # Enables using UploadedFile objects as hash keys.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:234
  def hash; end

  # The location where the file was uploaded to the storage.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:26
  def id; end

  # Returns simplified inspect output.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:254
  def inspect; end

  # A hash of file metadata that was extracted during upload.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:32
  def metadata; end

  # The MIME type of the uploaded file.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:65
  def mime_type; end
  ...
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:92
  def open(**options); end

  # Returns whether the file has already been opened.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:177
  def opened?; end

  # The filename that was extracted from the uploaded file.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:46
  def original_filename; end

  # Part of complying to the IO interface. It delegates to the internally
  # opened IO object.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:153
  def read(*args); end

  # Uploads a new file to this file's location and returns it.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:193
  def replace(io, **options); end

  # Part of complying to the IO interface. It delegates to the internally
  # opened IO object.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:165
  def rewind; end

  # Returns the Shrine class that this file's class is namespaced under.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:249
  def shrine_class; end

  # The filesize of the uploaded file.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:60
  def size; end

  # Returns the storage that this file was uploaded to.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:244
  def storage; end

  # The identifier of the storage the file is uploaded to.
  #
  # pkg:gem/shrine#lib/shrine/uploaded_file.rb:29
  def storage_key; end
